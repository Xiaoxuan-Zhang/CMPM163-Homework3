...
void main( void)
{
  vec3 dir = rayDirection(60.0, u_resolution.xy, gl_FragCoord.xy);
    ...
    vec3 U = vec3((0.1+ 0.2 * abs(sin(10.0*u_val + fragPos.x))),0.2+0.1 * abs(cos(5.0*u_val+fragPos.y)), (0.2+0.3 * abs(sin(20.0*u_val + fragPos.x)))); //Simplified
